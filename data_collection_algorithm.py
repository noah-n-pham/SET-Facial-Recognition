...
i = 0
while i < 100:
    #face_detection(source, "buffer.png")
    face_detection(source)
    if (cv2.waitKey(1) == 32):
        face_detection(source, "test/test_sample_" + str(i) + ".png")
        image = cv2.imread("test/test_sample_" + str(i) + ".png")
        cv2.imwrite( "test/test_sample_" + str(i + 1) + ".png", image)
        cv2.imwrite("test/test_sample_" + str(i + 2) + ".png", image)
        cv2.imwrite("test/test_sample_" + str(i + 3) + ".png", image)
        cv2.imwrite("test/test_sample_" + str(i + 4) + ".png", image)
        i += 5
        #cv2.imwrite()
